...
var MODAL_TOGGLE = 'video-react/MODAL_TOGGLE';
...
function (_Component) {
  ...
  _proto.getChildren = function getChildren() {
    ...
    if (!modalChildren || !modalChildren[0]) {
      return React.createElement("div", null, "Please add content through modalChildren props on Player Component");
    }
  ...
  _proto.render = function render() {
    ...
    return React.createElement("div", {
      className: classNames('video-react-modal', className)
    }, React.createElement("div", {
...
function (_Component) {
  ...
  function Player(props) {
    ...
    _this.handleFocus = _this.handleFocus.bind(_assertThisInitialized(_this));
    _this.handleBlur = _this.handleBlur.bind(_assertThisInitialized(_this));
    _this.handleModalToggle = _this.handleModalToggle.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _proto.handleModalToggle = function handleModalToggle() {
    var _this$manager$getStat2 = this.manager.getState(),
        player = _this$manager$getStat2.player;

    var isModalOpen = player.isModalOpen;
